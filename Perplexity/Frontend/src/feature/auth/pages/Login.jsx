    ...
    <div className="min-h-screen bg-[#08080f] flex items-center justify-center p-4 font-['DM_Sans',system-ui,sans-serif]">
      ...
      >
        ...
        >
          ...
          {/* social buttons */}
          <div className="flex flex-col gap-2.5 animate-[fadeUp_0.4s_ease_0.4s_both]">
            {[
              {
              ...
              },
              {
                ...
                icon: (
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="rgba(255,255,255,.75)">
              ...
              <button
                key={label}
                onClick={() => alert(`${label} will be available in the future!`)}
                className="w-full border-[1.5px] border-white/8 rounded-[11px] px-3.5 py-2.75 text-[13.5px] font-normal bg-white/3 text-white/70 cursor-pointer transition-all duration-200 flex items-center justify-center gap-2.5 font-[inherit] tracking-[0.01em] hover:bg-white/7 hover:border-white/15 hover:text-zinc-100"
              >
                {icon}{label}
              </button>
            ))}
